...
/**
 * Shared Files Page - Modern Redesign
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Files shared with you</p>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm">
            ...
            {!searchQuery && (
              <Link
                to="/dashboard"
                className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg"
              >
                Go to My Files
              </Link>
            )}
            ...
            {filteredFiles.map((file) => (
              ...
              >
                ...
                <div className="text-sm text-gray-500 space-y-1 mb-3">
                  ...
                  <p className="text-xs">Shared by: {file.sharedBy?.name || 'Unknown'}</p>
                  <p className="text-xs">{formatDate(file.sharedAt)}</p>
                </div>
              </div>
            ))}
          </div>
